...
export const WhatsAppButton: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#2e4e73] text-white py-2 text-center z-50">
      <button 
        onClick={openWhatsApp}
        className="flex items-center justify-center space-x-2 text-lg font-bold w-full"
      >
        <svg 
